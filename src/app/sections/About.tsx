        ...
        <div className=" flex justify-around flex-col sm:px-20 h-[70vh] bg-red gap-10">
          ...
          <div className="flex flex-col xl:self-end self-center w-[80vw] xl:w-[40vw] bg-white text-black p-[5vh] rounded-lg items-center gap-3">
            <div className="flex flex-col sm:flex-row sm:self-start sm:gap-5 gap-1 self-center">
              ...
              <img
                className="h-3 w-auto self-center"
                src="/icons/Star.png"
                alt="house"
              />
              <h3 className="text-2xl font-[TDSulog] self-center">
                [buy-uh-nee-hun]
              </h3>
            </div>
            <p className="text-[1rem]">
              Derived from the word bayan meaning town, nation, or community in
              general, &quot;Bayanihan&quot; translates to &quot;being a
              bayan,&quot; and refers to the spirit of communal unity and
              cooperation.
            </p>
          </div>
        </div>
