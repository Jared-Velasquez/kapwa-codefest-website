export default function Prizes() {
    return(
        <div className="flex flex-col">
            ...
            <div className="shadow-[4px_4px_9px_rgba(0,0,0,0.5)] self-center flex min-h-[50vh] sm:h-[65vh] w-[80vw] lg:w-[60vw] bg-[rgb(255,255,255,0.9)] text-black rounded-lg items-center flex-col-reverse xl:flex-row">
